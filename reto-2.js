...
fila.push("Diego");
console.log("Después de llegar Diego: [ \"" + fila.join('", "') + "\" ]");

// 2) Llega Eva al inicio
fila.unshift("Eva");
console.log("Después de llegar Eva: [ \"" + fila.join('", "') + "\" ]");

// 3) Atienden al primero
fila.shift();
console.log("Después de atender al primero: [ \"" + fila.join('", "') + "\" ]");

// 4) Se va el último
fila.pop();
console.log("Después de irse el último: [ \"" + fila.join('", "') + "\" ]");

// 5) La persona del medio (índice 1) abandona
fila.splice(1, 1);
console.log('Fila final: [ "' + fila.join('", "') + '" ]');
